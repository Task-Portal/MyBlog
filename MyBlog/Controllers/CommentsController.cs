...
namespace MyBlog.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create(
            [Bind("Id,Content,PublishDate,PublishTime,PostId,ApplicationUserId,ApplicationUserName")]
            Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Content,PostId,ApplicationUserId,Id,PublishDate,PublishTime")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
